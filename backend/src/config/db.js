  ...
  try {
    ...
    await pool.query(`
      CREATE TABLE IF NOT EXISTS programs (
        ...
        host VARCHAR(100),
        coverImage LONGTEXT,
        hostImage LONGTEXT NULL
      )
    `);

    try { await pool.query('ALTER TABLE programs ADD COLUMN hostImage LONGTEXT NULL'); } catch(e) {}
    ...
    try { await pool.query('ALTER TABLE videos ADD COLUMN likes INT DEFAULT 0'); } catch(e) {}

    // 2.1 Crear Tabla de Banners (Publicidad App Móvil y Web)
    await pool.query(`
